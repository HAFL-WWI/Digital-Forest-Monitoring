...
# calculate NDVI & NBR
ndvi_stk = calc_veg_indices (stk_1 = stk_b8, stk_2 = stk_b4, ndvi_raw_path, dates_all[1:12], veg_ind="NDVI", tilename=tile, ext=NULL, thr=thr)
stk_b12 = disaggregate(stack(b12),2)
nbr_stk = calc_veg_indices (stk_1 = stk_b8, stk_2 = stk_b12, nbr_raw_path, dates_all[1:12], veg_ind="NBR", tilename=tile, ext=NULL, thr=thr)
...
comp_tmp_name = paste(tile, "_NBR_comp_", dates_all[1], "_", dates_all[12], sep="")
