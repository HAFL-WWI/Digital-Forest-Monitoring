...
year = "2018"
months = c("06", "07")
tiles = c("T32TLT", "T32TLS", "T32TMT", "T32TMS", "T32TNS", "T32TMR", "T31TGM")
...
for(i in 1:length(tiles)){
  ...
  dates_2018_filter = paste(year, months, sep="")
  
  # calc max composite
  comp = calc_ndvi_max(images_path, band_names, dates_2018_filter, ext=NULL, ind=F)
  
  # write
  writeRaster(comp, file.path(out_path, paste("ndvi_max_", tiles[i], ".tif", sep="")))
}
