...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" version="1.0.0">
  <UserLayer>
    ...
    <sld:UserStyle>
      <sld:Name>ndvi_diff_2016_2015_thr200_gradient7</sld:Name>
        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="ramp">
              ...
              <sld:ColorMapEntry color="#fbdbb8" label="-0.09" quantity="-900" opacity="0.676051"/>
              <sld:ColorMapEntry color="#fce0c1" label="-0.08" quantity="-800" opacity="0.656764"/>
              <sld:ColorMapEntry color="#fce1c4" label="-0.07" quantity="-700" opacity="0.632197"/>
              <sld:ColorMapEntry color="#fce1c4" label="-0.06" quantity="-600" opacity="0.605371"/>
              <sld:ColorMapEntry color="#fce6cf" label="-0.05" quantity="-500" opacity="0.578531"/>
              <sld:ColorMapEntry color="#fdeddc" label="-0.04" quantity="-400" opacity="0.551705"/>
              <sld:ColorMapEntry color="#fdeedd" label="-0.03" quantity="-300" opacity="0.526726"/>
              <sld:ColorMapEntry color="#fdeedd" label="-0.02" quantity="-200" opacity="0.501961"/>
