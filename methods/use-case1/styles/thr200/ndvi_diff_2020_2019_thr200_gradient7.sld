        ...
        <sld:Rule>
          <sld:RasterSymbolizer>
            ...
            <sld:ColorMap type="ramp">
              ...
              <sld:ColorMapEntry color="#c0c0f2" opacity="0.67451" quantity="-900" label="-0.09"/>
              <sld:ColorMapEntry color="#c9c9f4" opacity="0.654902" quantity="-800" label="-0.08"/>
              <sld:ColorMapEntry color="#cbcbf4" opacity="0.631373" quantity="-700" label="-0.07"/>
              <sld:ColorMapEntry color="#cbcbf4" opacity="0.603922" quantity="-600" label="-0.06"/>
              <sld:ColorMapEntry color="#d4d4f6" opacity="0.580392" quantity="-500" label="-0.05"/>
              <sld:ColorMapEntry color="#e0e0f9" opacity="0.552941" quantity="-400" label="-0.04"/>
              <sld:ColorMapEntry color="#e1e1f9" opacity="0.52549" quantity="-300" label="-0.03"/>
              <sld:ColorMapEntry color="#e1e1f9" opacity="0.501961" quantity="-200" label="-0.02"/>
